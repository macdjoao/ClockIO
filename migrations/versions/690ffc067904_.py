...
Revision ID: 690ffc067904
Revises: 7e6984e7fea6
Create Date: 2022-09-01 01:24:00.268404
...
revision = '690ffc067904'
down_revision = '7e6984e7fea6'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('employee_password_hash', sa.String(length=255), nullable=False),
